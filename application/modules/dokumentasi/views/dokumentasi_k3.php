...
<head>
    ...
    <script type="text/javascript">
        ...
        var storedoc = Ext.create('Ext.data.Store', {
            ...
            proxy: {
             type: 'ajax',
             url: '<?php echo base_url() ?>dokumentasi/getdok/dokumentasi_k3',
             reader: {
                 type: 'json',
                 root: 'data'
             }
    ...
    handler: function(grid, rowIndex, colIndex){        
        ...
        Ext.MessageBox.confirm('Delete item', 'Apakah anda akan menghapus item ini?',function(resbtn){
           ...
           {
            Ext.Ajax.request({
             url: '<?=base_url();?>dokumentasi/deletedok/dokumentasi_k3',
             method: 'POST',
             params: {
              'id':id,
              'file':file
...
var formdoc = Ext.widget({
    ...
    layout: 'form',
        ...
        url: '<?php echo base_url(); ?>dokumentasi/insertdok/dokumentasi_k3',
        frame: false,
        bodyPadding: '5 5 0',
        width: 350,
        fieldDefaults: {
