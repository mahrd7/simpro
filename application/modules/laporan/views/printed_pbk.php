...
header("Content-Disposition: attachment; filename=PBK-01-$proyek->proyek.$file_ending");
...
<body>
	<div><font size="6">Posisi Biaya Konstruksi (PBK-01)</font></div>
	<div></div>
	...
	<table id="cashflow-grid" class="grid">
			<tr class="list_data_header">
				<td rowspan="3">KODE<br>RAP</td>
				<td rowspan="3">URAIAN</td>
				<td rowspan="3">SATUAN</td>	
				<td colspan="3">RAPA AWAL</td>					
				<td colspan="3">RAPA KINI</td>				
				<td colspan="2">TOTAL BK SD<br>BLN <?php echo $tgl_rab_lalu; ?></td>				
				<td colspan="14">BIAYA KONSTRUKSI BULAN <?php echo $tgl_rab; ?></td>				
				<td rowspan="3">BK BLN <?php echo $tgl_rab_lanjut; ?></td>	
			</tr>
			<tr class="list_data_header">
				<td></td>
				<td></td>
				...
				<td colspan="2">ANTISIPASI</td>
				<td colspan="2">TOTAL</td>
				<td colspan="3">SISA<br>ANGGARAN</td>
				<td colspan="2">PERK SD<br>SELESAI</td>
				<td rowspan="2">Total<br>DEVIASI</td>
			</tr>	
			<tr class="list_data_header">
				<td>VOL</td>
				<td>HARGA</td>
