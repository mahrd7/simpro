...
<head>
	<meta charset="UTF-8" />
	<title>Sisa Anggaran BK Akuntan</title>
...
<body>
	...
	?>
	<div class="titlegroup">BIAYA RAPA SISA ANGGARAN BEBAN KONTRAK</div>
	<div class="headgroup">		
		<div class="actions">
	...
	<div class="parameter">
		<table width="100%">
			...
			<tr>
				...
				<td width="2%" align="center">:</td>
				<td width="78%">
					<form action="<?php echo base_url();?>laporan/sisa_anggaran_bk_akuntan" method="post">
					<select name="bln">
						<?php 
							$bl[1]="January";
						    $bl[2]="February";
