...
header("Content-Disposition: attachment; filename=RLP-01-$proyek->proyek.$file_ending");
...
<body>
	...
	?>
	<div> <font size="6">REKAP LAPORAN PROYEK <?php echo strtoupper($tgl); ?> (RLP-01)</font></div>
	<div></div>
	<div class="headgroup">
	</div>
	<div class="parameter">
