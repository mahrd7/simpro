...
Ext.require([
    ...
    var store_tgl = Ext.create('Ext.data.Store', {
        ...
        autoLoad: false,        
         proxy: {
             type: 'ajax',
             url: '<?php echo base_url() ?>pengendalian/get_tanggal_rencana_kerja',
             reader: {
                 type: 'json',
                 root: 'data'
             }
...
var grid_lpf = Ext.create('Ext.grid.Panel', {
        ...
        columns: [
            ...
            handler: function(grid,rowIndex,colIndex){
                ...
                kunci = rec.get('kunci');
                window.location='<?php echo base_url() ?>pengendalian/rincian_rencana_kerja/'+kunci+'/'+tgl_rab;
            }
        }
        ],
        columnLines: true,
        height: '100%',
        title: 'RINCIAN RENCANA KERJA',
        dockedItems: [{
                xtype: 'toolbar',
                items: [
                {
