...
var required = '<span style="color:red;font-weight:bold" data-qtip="Required">*</span>';
    ...
    var store_check_data_induk_togo = Ext.create('Ext.data.Store', {
        ...
        proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>pengendalian/cek_data_induk_togo/cost_togo',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var store_sub_ctg = Ext.create('Ext.data.Store', {
        ...
        proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>pengendalian/get_sub_ctg/cost_togo',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var store_sub_ctg_new = Ext.create('Ext.data.Store', {
        ...
        proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>pengendalian/getdata_sub_ctg/cost_togo',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var store_get_kode = Ext.create('Ext.data.Store', {
        ...
        proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>pengendalian/get_kode_ctg/cost_togo',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var store_ctg_tree = Ext.create('Ext.data.TreeStore', {
        ...
        proxy: {
            ...
            url: '<?php echo base_url() ?>pengendalian/get_data_cost_to_go/cost_togo'
        },
        folderSort: false,
        remoteSort: true,
        autoLoad: false
    ...
    var storedivisi = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '<?php echo base_url() ?>pengendalian/get_combo/copy_divisi/ctg',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeproyek = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '<?php echo base_url() ?>pengendalian/get_combo/copy_proyek/ctg',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storetanggal = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '<?php echo base_url() ?>pengendalian/get_combo/copy_tgl/ctg',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storeanalisa = Ext.create('Ext.data.Store', {
        ...
        proxy: {
            ...
            url: '<?php echo base_url() ?>pengendalian/get_combo/copy_analisa/ctg',
            reader: {
                type: 'json',
                root: 'data'
            }
    ...
    var storegetedithargasatuan = Ext.create('Ext.data.Store', {
        ...
        proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>pengendalian/getdata_edit_hs_ctg/cost_togo',
         reader: {
             type: 'json',
             root: 'data'
         }
...
Ext.onReady(function() {
    ...
    var rowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
        ...
        listeners: {
            ...
            afteredit: function(rec,obj) {
                ...
                Ext.Ajax.request({
                     url: '<?=base_url();?>pengendalian/update_ctg/cost_togo',
                        method: 'POST',
                        params: {
                            'id' :  id,
    ...
    var grid = Ext.create('Ext.tree.Panel', {
        ...
        singleExpand: false,
        plugins: [rowEditing],
        title: 'Cost To Go <?php echo $bln; ?> Tahun <?php echo $thn; ?>',
        columns: [
            ...
            handler: function(rec, rowIndex, colIndex){
                ...
                Ext.MessageBox.confirm('Delete item', 'Apakah anda akan menghapus item ini?',function(resbtn){
                    ...
                    {
                        Ext.Ajax.request({
                             url: '<?=base_url();?>pengendalian/delete_data/cost_togo',
                                method: 'POST',
                                params: {
                                    'id' :  id,
                                    'kode': no,
            ...
            {text: "VOL SISA<br>ANGGARAN", width:80, sortable: true, dataIndex: 'tahap_volume_kendali',
                editor:{
                    xtype:'numberfield',
                    itemId:'volume'
                }
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                tooltip:'Kembali',
                handler: function(){
                    var url ='<?php echo base_url(); ?>pengendalian/pilihcosttogo';
                    // console.log(url);
                    window.location=url;
                }
            }]
...
function tambahctg(kode){
    var frmadd = Ext.create('Ext.form.Panel', {     
        url: '<?php echo base_url() ?>pengendalian/insert_ctg/cost_togo/<?php echo $tgl_rab ?>',
...
function tambahlink(kode,kode_induk,tgl_rab){
    var frmadd = Ext.create('Ext.form.Panel', {     
        url: '<?php echo base_url() ?>pengendalian/insert_sub_ctg/cost_togo/'+kode+'/'+tgl_rab,
        width:'100%',
        height:'100%',
...
function analisa(id,no){
    ...
    var rowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
        ...
        listeners: {
            afteredit: function(rec,obj) {
                ...
                Ext.Ajax.request({
                     url: '<?=base_url();?>pengendalian/update_analisa_ctg/cost_togo',
                        method: 'POST',
                        params: {
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        plugins: [rowEditing],
        columns: [
            {text: "SUMBER DAYA", flex:1, sortable: true, dataIndex: 'nama'},
            ...
            handler: function(grid, rowIndex, colIndex){
                ...
                Ext.MessageBox.confirm('Delete item', 'Apakah anda akan menghapus item ini?',function(resbtn){
                    ...
                    {
                        Ext.Ajax.request({
                             url: '<?=base_url();?>pengendalian/delete_data/analisa_cost_togo',
                                method: 'POST',
                                params: {
                                    'id' :  id,
                                    'tgl_rab':'<?php echo $tgl_rab ?>'
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                handler: function(){
                    Ext.MessageBox.confirm('Delete Analisa', 'Apakah anda akan menghapus semua item analisa?',function(resbtn){
                        if(resbtn == 'yes')
                        {
                            Ext.Ajax.request({
                                 url: '<?=base_url();?>pengendalian/delete_data/analisa_ctg_all',
                                    method: 'POST',
                                    params: {
                                        'kode' :  no,
                                        'tgl_rab':'<?php echo $tgl_rab ?>'
        ...
        dockedItems: [{
            ...
            items: [{
                ...
                handler: function(){
                    ...
                    Ext.Ajax.request({
                        url: '<?=base_url();?>pengendalian/insert_induk_togo_induk/cost_togo',
                        method: 'POST',
                        params: {
                            'id' :  no,
                            'tgl_rab':'<?php echo $tgl_rab ?>'
                    ...
                    for (i = 0; i < selectedNode.length; i++) {
                        Ext.Ajax.request({
                            url: '<?=base_url();?>pengendalian/insert_induk_komposisi_togo/cost_togo',
                            method: 'POST',
                            params: {
                                'id' :  no,
    ...
    var rowEditing = Ext.create('Ext.grid.plugin.RowEditing', {
        ...
        listeners: {
            afteredit: function(rec,obj) {
                ...
                Ext.Ajax.request({
                     url: '<?=base_url();?>pengendalian/update_hs_ctg/cost_togo',
                        method: 'POST',
                        params: {
                            'kode' :  kode_material,
                            'tgl_rab':'<?php echo $tgl_rab ?>',
...
function copy_analisa(no){
    storedivisi.load();
    var frmadd = Ext.create('Ext.form.Panel', {     
        url: '<?php echo base_url() ?>pengendalian/copy/analisa_to_an_ctg',
        bodyStyle: 'padding:5px 5px 0',
        autoScroll: true,
        frame: false,
        fieldDefaults: {
