...
Ext.require([
	...
	Ext.define('mdl', {
        ...
        fields: [
        	{name: 'sumberdana_id', mapping: 'sumberdana_id'},
            {name: 'sumberdana_kode', mapping: 'sumberdana_kode'},
            {name: 'sumberdana_nama', mapping: 'sumberdana_nama'},            
...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.Store', {
     ...
     proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>admin/getdata/sumber_dana',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        store: store,
        columns: [
            {text: "Sumber Dana Kode", flex:1, sortable: true, dataIndex: 'sumberdana_kode'},
            {text: "Sumber Dana Nama", flex:1, sortable: true, dataIndex: 'sumberdana_nama'},
            ...
            handler: function(grid, rowIndex, colIndex){
            	...
            	var id = rec.get('sumberdana_id');
				var kode = rec.get('sumberdana_kode');
				var nama = rec.get('sumberdana_nama');
            ...
            handler: function(grid, rowIndex, colIndex){
				...
				Ext.MessageBox.confirm('Delete item', 'Apakah anda akan menghapus item ini?',function(resbtn){
							...
							{
								Ext.Ajax.request({
									url: '<?=base_url();?>admin/deletedata/sumber_dana',
									method: 'POST',
									params: {
										'id' :  id
									},								
    ...
    var frmadd = Ext.create('Ext.form.Panel', {    	
        url: '<?php echo base_url() ?>admin/insertdata/sumber_dana',
        id:'frmadd ',
	...
	var frmedit = Ext.create('Ext.form.Panel', {    	
        url: '<?php echo base_url() ?>admin/editdata/sumber_dana',
        id:'frmedit ',
        bodyStyle: 'padding:5px 5px 0',
        width: '100%',
        autoScroll: true,
