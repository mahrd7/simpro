...
Ext.require([
	...
	Ext.define('mdl', {
        ...
        fields: [
        	{name: 'id_dir', mapping: 'id_dir'},
            {name: 'kode_dir', mapping: 'kode_dir'},
            {name: 'nama_dir', mapping: 'nama_dir'},            
...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.Store', {
     ...
     proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>admin/getdata/direktorat',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        store: store,
        columns: [
            {text: "nama_dir Kode", flex:1, sortable: true, dataIndex: 'kode_dir'},
            {text: "nama_dir Nama", flex:1, sortable: true, dataIndex: 'nama_dir'},
            ...
            handler: function(grid, rowIndex, colIndex){
            	...
            	var id = rec.get('id_dir');
				var kode = rec.get('kode_dir');
				var nama = rec.get('nama_dir');
            ...
            handler: function(grid, rowIndex, colIndex){
				...
				Ext.MessageBox.confirm('Delete item', 'Apakah anda akan menghapus item ini?',function(resbtn){
							...
							{
								Ext.Ajax.request({
									url: '<?=base_url();?>admin/deletedata/direktorat',
									method: 'POST',
									params: {
										'id' :  id
									},								
	...
	var frmedit = Ext.create('Ext.form.Panel', {    	
        url: '<?php echo base_url() ?>admin/editdata/direktorat',
        id:'frmedit ',
        bodyStyle: 'padding:5px 5px 0',
        width: '100%',
        autoScroll: true,
