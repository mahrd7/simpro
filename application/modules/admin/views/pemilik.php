...
Ext.require([
	...
	Ext.define('mdl', {
        ...
        fields: [
        	{name: 'pemilik_id', mapping: 'pemilik_id'},
            {name: 'pemilik_kode', mapping: 'pemilik_kode'},
            {name: 'pemilik_nama', mapping: 'pemilik_nama'},            
...
Ext.onReady(function() {
    ...
    var store = Ext.create('Ext.data.Store', {
     ...
     proxy: {
         type: 'ajax',
         url: '<?php echo base_url() ?>admin/getdata/pemilik',
         reader: {
             type: 'json',
             root: 'data'
         }
    ...
    var grid = Ext.create('Ext.grid.Panel', {
        ...
        store: store,
        columns: [
            {text: "Pemilik Kode", flex:1, sortable: true, dataIndex: 'pemilik_kode'},
            {text: "Pemilik Nama", flex:1, sortable: true, dataIndex: 'pemilik_nama'},
            ...
            handler: function(grid, rowIndex, colIndex){
            	...
            	var id = rec.get('pemilik_id');
				var kode = rec.get('pemilik_kode');
				var nama = rec.get('pemilik_nama');
            ...
            handler: function(grid, rowIndex, colIndex){
				...
				Ext.MessageBox.confirm('Delete item', 'Apakah anda akan menghapus item ini?',function(resbtn){
							...
							{
								Ext.Ajax.request({
									url: '<?=base_url();?>admin/deletedata/pemilik',
									method: 'POST',
									params: {
										'id' :  id
									},								
    ...
    var frmadd = Ext.create('Ext.form.Panel', {    	
        url: '<?php echo base_url() ?>admin/insertdata/pemilik',
        id:'frmadd ',
	...
	var frmedit = Ext.create('Ext.form.Panel', {    	
        url: '<?php echo base_url() ?>admin/editdata/pemilik',
        id:'frmedit ',
        bodyStyle: 'padding:5px 5px 0',
        width: '100%',
        autoScroll: true,
